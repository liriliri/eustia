(function ()
{
    ...
    _define('has', ['_objProto'], function (_objProto)
    {
        var exports;
    ...
    _define('_createAssigner', ['undefined'], function (undefined)
    {
        var exports;
    ...
    _define('toString', ['_objProto'], function (_objProto)
    {
        var exports;
