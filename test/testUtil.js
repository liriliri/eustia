(function ()
{
    ...
    _define('Cookies', ['extend', 'isNumber', 'escape', 'undefined'], function (extend, isNumber, escape, undefined)
    {
        var exports;
    ...
    _define('escape', ['createEscaper'], function (createEscaper)
    {
        var exports;
    ...
    _define('createEscaper', ['invert', 'keys'], function (invert, keys)
    {
        var exports;
